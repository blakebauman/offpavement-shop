  ...
  await createProductsWorkflow(container).run({
    input: {
      products: [
        ...
        {
          title: "Compact Frame Bag",
          category_ids: [
            categoryResult.find((cat) => cat.name === "Frame Bags")!.id,
          ],
          description: "Low-profile frame bag for small to medium front triangles. Water-resistant, minimal weight.",
          handle: "compact-frame-bag",
          weight: 180,
          status: ProductStatus.PUBLISHED,
          shipping_profile_id: shippingProfile.id,
          metadata: {
        ...
        },
        {
          ...
          description: "10-liter seat bag for overnight and multi-day trips. Fits rigid and hardtail frames.",
          handle: "seat-bag-10l",
          weight: 320,
          status: ProductStatus.PUBLISHED,
          shipping_profile_id: shippingProfile.id,
          metadata: {
            ...
            compatibility_rules: [
              {
                type: "excludes",
                attribute: "suspension",
                operator: "eq",
                value: "full_sus",
                message: "This seat bag requires a rigid or hardtail frame for proper mounting clearance",
              },
            ],
          },
          images: [
