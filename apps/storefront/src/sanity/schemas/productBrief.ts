/**
 * Sanity productBrief schema for editorial PDP content.
 * Add to your Sanity Studio's schema types array.
 *
 * Usage in sanity.config.ts:
 *   import { productBrief } from './schemas/productBrief'
 *   schema: { types: [productBrief, ...] }
 */
  ...
  fields: [
    {
      ...
      description: "Links this brief to a product in Medusa",
